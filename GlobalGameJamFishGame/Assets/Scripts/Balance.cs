...
public class Balance : MonoBehaviour
{
    ...
    void Update()
    {
        if (AC1.AmmountCollectedBlue == AC2.AmmountCollectedOrange || AC1.AmmountCollectedBlue < 0 && AC2.AmmountCollectedOrange<0)
        {
        ...
        else if (AC1.AmmountCollectedBlue < AC2.AmmountCollectedOrange && AC2.AmmountCollectedOrange > 0)
        {
        ...
        else if (AC1.AmmountCollectedBlue > AC2.AmmountCollectedOrange && AC1.AmmountCollectedBlue > 0)
        {
